...
void main() async {
  final inputFile = File('vp80-00-comprehensive-001.ivf');
  final outputFile = File('decoded.yuv');
  ...
  if (res != vpx_codec_err_t.VPX_CODEC_OK) {
    throw Exception("Decoder init failed: $res");
  }
  ...
  while (true) {
    ...
    if (decodeRes != vpx_codec_err_t.VPX_CODEC_OK) {
      print("Decode error: $decodeRes");
      continue;
    }
