...
class GCM {
  final AesGcm srtpGCM;
  final AesGcm srtcpGCM;
  final SecretKey srtpSalt;
  final SecretKey srtcpSalt;

  GCM._(this.srtpGCM, this.srtpSalt, this.srtcpGCM, this.srtcpSalt);
...
Uint8List rtpInitializationVector(RtpHeader header, int roc) {
  ...
  Uint8List _generateAEADAdditionalData(RecordHeader header, int payloadLen) {
    ...
    byteData.setUint8(9, header.version.major);
    byteData.setUint8(10, header.version.minor);
