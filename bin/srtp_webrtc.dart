...
import 'package:dart_webrtc/src/srtp2/protection_profiles.dart';
import 'package:dart_webrtc/src/srtp2/rtp_packet.dart';
import 'package:dart_webrtc/src/srtp2/srtp_context.dart';
        ...
        if (stun.StunMessage.isStunMessage(d.data)) {
          ...
          if (initSrtp && srtpContext.gcm != null) {
            srtpContext.decryptRtpPacket(packet.packet).then((decrypted) {
              ...
              final decryptedPacket =
                  Packet.decodePacket(decrypted, 0, decrypted.length);
              print("decrypted packet: ${decryptedPacket.packet}");
